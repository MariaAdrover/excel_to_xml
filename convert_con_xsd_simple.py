...
def create_and_save_xml(df, output_dir, base_name, max_records=None):
    xml_files = []
...
def create_xml_files(df, column, max_records, output_dir, script_dir, base_name):
    ...
    if column:
        ...
        for group_name, group in grouped:
            xml_files.extend(create_and_save_xml(group, output_dir, group_name, max_records))
    else:
        xml_files = create_and_save_xml(df, output_dir, base_name, max_records)
